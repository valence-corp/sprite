...
describe('DocumentModality.newDocument()', () => {
    ...
    beforeEach(() => {
        jest
            ...
            .mockImplementationOnce(async (lanugage, options) => newDocumentCommandResponse);
    });
    it(`correctly passes typeName, options.data, and options.transactionId to SpriteOperations._insertRecord`, async () => {
        // Act
        await testClient_js_1.client.newDocument(typeName, testClient_js_2.testTransaction, {
            data: {
                aProperty: 'aValue',
            },
        });
...
//# sourceMappingURL=newDocument.test.js.map